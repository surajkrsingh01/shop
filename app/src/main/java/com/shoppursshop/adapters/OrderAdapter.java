...
import com.shoppursshop.activities.order.OrderDetailActivity;
import com.shoppursshop.activities.order.MyOrderDetailsActivity;
            ...
            switch (motionEvent.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if(sharedPreferences.getString(Constants.SHOP_CODE,"").equals(item.getCustCode())){
                        ...
                        intent.putExtra("id",item.getId());
                        intent.putExtra("orderNumber",item.getOrderNumber());
                        intent.putExtra("partnerOrderId",item.getPartnerOrderId());
